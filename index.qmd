...
format:
    html: 
      ...
      include-in-header:
        - text: |
             <script defer data-domain="eoss-om-communitycalls.github.io" src="https://a.duckles.nz/js/script.js"></script>
      grid: 
        margin-width: 350px
      other-links: 
        - text: Github
          icon: github
          href: https://github.com/eoss-om-communitycalls/2024-07-29-managing-an-oss-project        
    pdf: default
    epub: default
execute: 
  echo: fenced
